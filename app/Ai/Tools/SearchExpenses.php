...
class SearchExpenses implements Tool
{
    ...
    {
        return 'Busca gastos del presupuesto actual, puedes filtrar por nombre, gasto más barato o
        costoso, buscar gastos por categoría o traer y mostrar todos los gastos';
    }
